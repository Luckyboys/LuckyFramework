  ...
  implements Swift_Transport
{
  ...
  public function start()
  {
    if (!$this->_started)
    {
      if ( ( $evt = $this->_eventDispatcher->createTransportChangeEvent($this) ) != false )
      {
  ...
  public function send(Swift_Mime_Message $message, &$failedRecipients = null)
  {
    ...
    if ( ( $evt = $this->_eventDispatcher->createSendEvent($this, $message) ) != false )
    {
  ...
  public function executeCommand($command, $codes = array(), &$failures = null)
  {
    ...
    if ( ( $evt = $this->_eventDispatcher->createCommandEvent($this, $command, $codes) ) != false )
    {
  ...
  {
    if ( ( $evt = $this->_eventDispatcher->createTransportExceptionEvent($this, $e) ) != false)
    {
  ...
  protected function _assertResponseCode($response, $wanted)
  {
    ...
    if ( ( $evt = $this->_eventDispatcher->createResponseEvent($this, $response, $valid) ) != false )
    {
